...
func main() {
	...
	app.Name = "builder"
	app.Usage = "Generates a new schollz/cli build!"
...
func TestActionFunc(c *cli.Context) error {
	for _, pkg := range packages {
		...
		if pkg == "cli" {
			packageName = "github.com/schollz/cli/v2"
		} else {
			packageName = fmt.Sprintf("github.com/schollz/cli/v2/%s", pkg)
		}
...
// this was originally inspired by https://github.com/schollz/cli/issues/1055, and followed up on as a part
// of https://github.com/schollz/cli/issues/1057
